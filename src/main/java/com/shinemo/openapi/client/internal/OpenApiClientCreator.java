 ...
 */
public final class OpenApiClientCreator {

    public static OpenApiClient create(OpenApiConfiguration conf) {
        DefaultOpenApiClient client = new DefaultOpenApiClient(conf);
        client.init();
        return client;
    }
}
